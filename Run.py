...
for xiaominok in range(5000):
	...
	useragent1 = f"Mozilla/5.0 (Linux; Android {str(rr(6,13))}; ZTE {str(rr(8000,9999))}) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/{str(rr(50,104))}.0.{str(rr(3900,5900))}.{str(rr(40,150))} Mobile Safari/537.36"
	useragent3 = f"Mozilla/5.0 (Linux; U; Android {str(rr(6,13))}; {bahasa_perangkat}; Xiaomi 13 Pro Build/TKQ1.220905.001) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/{str(rr(50,104))}.0.{str(rr(3900,5900))}.{str(rr(40,150))} Mobile Safari/537.36 XiaoMi/MiuiBrowser/13.28.0-gn"
	uaku2 = random.choice([useragent1, useragent3])
	ugen.append(uaku2)
def menu_apikey():
