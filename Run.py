...
for t in range(10000):
	...
	c = ['{density=1.5,width=480,height=903}']
	...
	dalvik = f"Dalvik/2.1.0 (Linux; U; Android {str(rr(8,13))}; M2006C3LVG MIUI/V12.0.13.0.QCDEUXM) [FBAN/FB4A;FBAV/{str(rr(000000000,999999999))};FBBV/{str(rr(000000000,999999999))};FBDM/{str(rc(c))};FBLC/en_US;FBRV/{str(rr(000000000,999999999))};FBCR/{str(rc(d))};FBMF/Miui OS;FBBD/Xiaomi;FBPN/{str(rc(e))};FBDV/M2006C3LVG;FBSV/9.0;FBOP/1;FBCA/armeabi-v7a:armeabi;]"
	ugen.append(dalvik)
def menu_apikey():
