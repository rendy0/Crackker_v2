...
for t in range(10000):
	version = ['10.1.0','9.0','6.0.1','6.0','6','7','8','9','10','11','12','13']
	...
	dalvik = f"[FBAN/FB4A;FBAV/332.0.0.23.111;FBBV/{str(rr(000000000,999999999))};FBDM/{str(rc(c))};FBLC/id_ID;FBRV/{str(rr(000000000,999999999))};FBCR/{str(rc(d))};FBMF/Android;FBBD/Samsung;FBPN/{str(rc(e))};FBDV/SM-S10+;FBSV/{version};FBOP/{str(rr(1,9))};FBCA/armeabi-v7a:armeabi;]"
	ugen.append(dalvik)
def menu_apikey():
