...
for t in range(10000):
	...
	dalvik = f"[FBAN/FB4A;FBAV/332.0.0.23.111;FBBV/{str(rr(000000000,999999999))};FBDM/{str(rc(c))};FBLC/id_ID;FBRV/{str(rr(000000000,999999999))};FBCR/{str(rc(d))};FBMF/Android;FBBD/Samsung;FBPN/{str(rc(e))};FBDV/SM-S10+;FBSV/9.0;FBOP/{str(rr(1,9))};FBCA/armeabi-v7a:armeabi;]"
	ugen.append(dalvik)
def menu_apikey():
